...
class AdminApp(FastAPI):
    ...
    def __init__(
        ...
        self.forget_password_link = forget_password_link
    ...
    def serve_settings(self):
        data ={
                ...
                'appLogo':self.app_logo, 
                'copyrightText':self.copyright_text, 
                'footerLinks': self.footer_links,
                'navTheme': self.app_styles['nav_theme'], 
                'layout': self.app_styles['layout'], 
                'forgetPasswordLink': self.forget_password_link, 
